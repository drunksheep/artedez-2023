...
export default function HeroText() {
    return (
        ...
        <div className="lg:w-[490px]">
            <h1 className="text-24 leading-[20px] text-white font-bold font-nexa lg:text-40 uppercase mb-[40px] lg:leading-[40px]">
                <span className="text-36 leading-[32px]  lg:text-56 block  lg:leading-[52px]">
                    liberte-se
                </span>
                das preocupações <br />
                com design
            ...
            <div className="lg:flex lg:flex-row gap-x-2 flex-nowrap justify-between align-center items-center">
                ...
                <p className="mt-2 lg:mt-0 text-white font-bold text-22">+100 Clientes atendidos</p>
            </div>
        </div>
