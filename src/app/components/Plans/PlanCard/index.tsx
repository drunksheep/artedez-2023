        ...
        <div className="border-4 border-white rounded-[52px] bg-transparent p-5 lg:py-6 lg:px-10 transition-all duration-400 ease-in-out hover:bg-white group grid grid-cols-1 content-between">
            ...
            <div className="align-self-end mt-8">
                ...
                }
                {
                    ...
                    className="bg-green-400 text-white border-4 border-white rounded-full min-h-[60px] text-20 text-center gap-x-3 justify-center flex flex-row items-center px-4 duration-400 ease-in-out transition-all hover:bg-green-500" target="_BLANK" rel="noopener noreferrer"> 
