            ...
            <div className="align-self-end mt-5 lg:mt-8 w-full">
                ...
                }
                {
                    ...
                    <a href={props.ctaString}
                        className="bg-green-400 text-white border-4 border-white rounded-full min-h-[60px] text-20 text-center gap-x-3 justify-center flex flex-row items-center px-4 duration-400 ease-in-out transition-all font-bold w-full mx-auto" target="_BLANK" rel="noopener noreferrer">
                        Preciso desse kit!
                    </a>
                }
            </div>
